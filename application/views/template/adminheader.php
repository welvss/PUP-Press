...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Site Administrator | Polytechnic University of the Philippines | Journal</title>
    <link rel="icon" type="image/x-icon" href="<?php echo base_url('assets/favicon.ico'); ?>">
    <link rel="stylesheet" href="<?php echo base_url('assets/bower_components/datatables.net-zf/css/dataTables.foundation.css');?>">
    <link rel="stylesheet" href="<?php echo base_url('assets/css/app.css'); ?>">
  </head>
  <body class="homepage">
<div class="wrapper">
<!--Header-->
   <div id="header-wrapper" class="Site-admin">
     <header  id="header">
      <!--MainHeader-->
       <div class="inner">
        ...
        <div id="right-nav">
         ...
         <div id="login-nav">
            <ul class="ulnav breadcrumbs">
              ...
              <li><a href="#">Logged in as: <?php echo $this->mdladmin->user_name();?></a></li>
            </ul>
          </div>
        </div>
            <!--Subject Navigation-->
   <nav id="nav">
    ...
    <nav id="nav2">
        <ul class="nav">
            <li><span><?php echo $this->mdladmin->user_firstname()." ".$this->mdladmin->user_lastname();?></span></li>
